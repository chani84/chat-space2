$(function(){
  ...
  $("#user-search-field").on('keyup', function(){
    var input = $(this).val();
    var register_user = $('#user-search-result');
  ...
  function appendAddUser(user_id, user_name) {
    var html = `<div class="chat-group-user clearfix">
                   ...
                   <a class="user-search-add chat-group-user__btn chat-group-user__btn--add" data-user-id=${ user_id } data-user-name=${ user_name }>削除</a>
                </div>`
